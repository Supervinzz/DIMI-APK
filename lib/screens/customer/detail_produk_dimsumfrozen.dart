...
class DetailProdukFrozenPage extends StatefulWidget {
  const DetailProdukFrozenPage({super.key});

  @override
  State<DetailProdukFrozenPage> createState() =>
      _DetailProdukFrozenPageState();
}

class _DetailProdukFrozenPageState extends State<DetailProdukFrozenPage> {
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Dimsum ayam beku siap masak, dikemas dalam '
                          'kondisi frozen agar kualitas dan kesegarannya '
                          'tetap terjaga. Cocok untuk stok di rumah, tinggal '
                          'dikukus atau digoreng kapan saja saat ingin '
                          'menikmati dimsum hangat tanpa ribet.',
                          style: TextStyle(
                            fontSize: 13,
                            color: Colors.black54,
                            height: 1.45,
    ...
    return Stack(
      children: [
        SizedBox(
          ...
          child: Image.network(
            'https://images.unsplash.com/photo-1626200926749-458c6ea1c3ea?w=800',
            fit: BoxFit.cover,
      ...
      children: [
        Container(
          ...
          child: const Row(
            ...
            children: [
              Icon(Icons.ac_unit, size: 13, color: kOrange),
              SizedBox(width: 4),
              Text(
                'Isi 10 pcs • Frozen',
                style: TextStyle(
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Contoh: Dikemas terpisah per 5 pcs',
