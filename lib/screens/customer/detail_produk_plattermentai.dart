...
class DetailProdukPlatterMentaiPage extends StatefulWidget {
  const DetailProdukPlatterMentaiPage({super.key});

  @override
  State<DetailProdukPlatterMentaiPage> createState() =>
      _DetailProdukPlatterMentaiPageState();
}

class _DetailProdukPlatterMentaiPageState
    extends State<DetailProdukPlatterMentaiPage> {
  ...
  final int _hargaSatuan = 65000;

  final List<Map<String, String>> _pilihanSaus = const [
    {'nama': 'Saus Mentai Original', 'harga': 'Gratis'},
    {'nama': 'Saus Mentai Pedas', 'harga': 'Gratis'},
    {'nama': 'Campur (Original & Pedas)', 'harga': 'Gratis'},
  ];
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Satu platter berisi aneka dimsum pilihan yang '
                          'disiram saus mentai creamy khas Jepang dan '
                          'taburan bubuk katsuobushi. Cocok untuk dinikmati '
                          'bareng keluarga atau teman, satu porsi besar '
                          'yang bikin momen makan makin seru.',
                          style: TextStyle(
                            fontSize: 13,
                            color: Colors.black54,
                            height: 1.45,
      ...
      children: [
        Container(
          ...
          child: const Row(
            ...
            children: [
              Icon(Icons.groups_outlined, size: 13, color: kOrange),
              SizedBox(width: 4),
              Text(
                'Untuk 3-4 orang',
                style: TextStyle(
